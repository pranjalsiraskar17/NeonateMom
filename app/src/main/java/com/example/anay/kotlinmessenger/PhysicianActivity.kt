...
import kotlinx.android.synthetic.main.activity_physician.*


class PhysicianActivity : AppCompatActivity() {
    ...
    private fun saveUserToFirebaseDatabase() {
        ...
        val neonat="Physician"
        val user = User1(uid, name_edittext_register.text.toString(),mobile_edittext_register.text.toString(),address_edittext_register.text.toString(),email_edittext_register.text.toString(),password_edittext_register.text.toString(),neonat)
...
class User1(val uid: String, val name: String,val mobile: String,val admitdate: String,val email: String,val password: String, val neonat: String)